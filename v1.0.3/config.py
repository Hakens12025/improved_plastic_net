...
# 模型保存路径
MODEL_SAVE_PATH = 'v1_0_3_optimized_plastic_net_fashion_mnist.pth'

# 性能数据保存路径
PERFORMANCE_SAVE_PATH = 'v1_0_3_optimized_plastic_net_fashion_mnist_performance.json'
...
# ========================================
# Continuous mode config (main.py)
# ========================================

# Input/output dims for continuous mode
CONTINUOUS_INPUT_DIM = 784
CONTINUOUS_OUTPUT_DIM = 10

# Continuous mode batch size
CONTINUOUS_BATCH_SIZE = 1

# Idle plasticity
ENABLE_IDLE_PLASTICITY = True
IDLE_PLASTICITY_INTERVAL_SEC = 10
IDLE_PLASTICITY_GRACE_SEC = 5

# ========================================
# Continuous data source
# ========================================

# Options: "fashion_mnist" or "file_queue"
CONTINUOUS_DATA_MODE = "fashion_mnist"

# FashionMNIST settings
FASHION_MNIST_ROOT = "../data"
FASHION_MNIST_TRAIN = True
FASHION_MNIST_DOWNLOAD = True
FASHION_MNIST_AUGMENT = True

# File queue settings (used when CONTINUOUS_DATA_MODE = "file_queue")
FILE_INPUT_DIR = "data_inbox"
FILE_PROCESSED_DIR = "data_processed"
FILE_POLL_INTERVAL_SEC = 1

# ========================================
# One-shot file ingest (insert.py)
# ========================================

# Put files into TODO_DIR and run: python insert.py
TODO_DIR = "todo"
DONE_DIR = "done"
