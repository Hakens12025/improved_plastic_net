...
生成的文件：
1. **v1_0_2_optimized_plastic_net_mnist.pth** - 模型权重
2. **v1_0_2_optimized_plastic_net_mnist_performance.json** - 性能数据
...
```bash
# 保存1000神经元的结果
mv v1_0_2_optimized_plastic_net_mnist.pth results_1000neurons.pth
mv training_history.png results_1000neurons_history.png

# 保存2000神经元的结果
mv v1_0_2_optimized_plastic_net_mnist.pth results_2000neurons.pth
